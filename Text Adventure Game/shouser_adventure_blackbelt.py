# Steven Houser
# Choose Your Own Adventure Game - Blackbelt Extension
# 09/26/25
...
def getGame():
    game = {
        ...
        "sneak_success": ["You successfully sneak past the sleeping bear and find yourself in a chamber filled with old adventurer gear and bones.", "Take the magical sword from the bones", "dragon_encounter", "Search through the adventurer packs", "unstable_portal"],
        ...
        "treasure_island": ["The boat carries you to a small island in the center of the lake. Here stands an ancient shrine with a glowing gem.", "Take the gem of power", "wizard_path", "Leave the gem and explore the shrine", "unstable_portal"],
        ...
        # Blackbelt Extension: Unstable Portal Node
        "unstable_portal": ["You discover a shimmering, unstable magical portal crackling with chaotic energy. Ancient warnings are carved around it, but the portal pulses with mysterious power.", "Step through the portal bravely", "random", "Try to stabilize the portal first", "random"]
    }
...
def playNode(game, currentNode):
    ...
    # Blackbelt Extension: Handle random portal logic
    if nextNode == "random":
        # List of possible destinations from the portal
        portal_destinations = ["beast_chamber", "magic_chamber", "underground_lake", "dragon_encounter", "ancient_altar", "wizard_path"]
        nextNode = random.choice(portal_destinations)
        print(f"The unstable portal crackles and warps reality around you!")
        print(f"When the energy dissipates, you find yourself somewhere unexpected...")
